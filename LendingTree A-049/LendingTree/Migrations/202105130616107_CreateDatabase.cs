namespace LendingTree.Migrations
{
    ...
    public partial class CreateDatabase : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    Password = c.String(nullable: false),
                    NoOfApplications = c.Int(nullable: false, defaultValue: 0),
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    PANNo = c.String(nullable: false),
                    AadharNo = c.Long(nullable: false),
                    BankAccountNo = c.Long(nullable: false),
                    Approved = c.Boolean(nullable: false),
                    VerifiedByVerificationAgency = c.Boolean(nullable: false, defaultValue: false),
                    VerifiedByPickUpAgent = c.Boolean(nullable: false, defaultValue: false),
                    VerifiedByLegalAgent = c.Boolean(nullable: false, defaultValue: false),
                    Sanctioned = c.Boolean(nullable: false, defaultValue: false),
                    Remarks = c.String(),
                    FK_VerificationAgent = c.String(maxLength: 128),
                ...
                .ForeignKey("dbo.Agents", t => t.FK_VerificationAgent)
                .ForeignKey("dbo.Agents", t => t.Agent_AgentId)
                .Index(t => t.FK_VerificationAgent)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Loans", "FK_VerificationAgent", "dbo.Agents");
            ...
            DropIndex("dbo.Loans", new[] { "FK_VerificationAgent" });
